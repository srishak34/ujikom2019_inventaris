...
<div class="container-fluid">	
	<div class="row justify-content-center">
		<div class="col-sm-10">			
			<h4 class="text-center">Laporan Data Transaksi Peminjaman</h4>
			<hr>
			<div class="row">
				<div class="col-sm-9">
					<a class="btn btn-sm btn-dark" href="export_to_pdf_tpeminjaman" target="_BLANK">Print Laporan Transaksi Peminjaman</a>
				</div>
				<div class="col-sm-3">
					<form action="/search" method="POST">
						@csrf
						<div class="input-group">
							<input name="path" value="{{ Request::path() }}" hidden>

...
<div class="container-fluid">	
	<div class="row justify-content-center">
		<div class="col-sm-10">			
			...
			<div class="row">
				<div class="col-sm-9">
					<a class="btn btn-sm btn-success" href="dataPetugas/create">Buat Data Petugas Baru</a>
				</div>
				<div class="col-sm-3">
			...
			<div class="table-responsive">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center"><a class="btn btn-sm btn-primary" href="dataPetugas/{{ $data->id }}/update">Edit</a></td>
						<td class="text-center">
							<form action="dataPetugas/{{ $data->id}}/delete" method="post">
								@csrf

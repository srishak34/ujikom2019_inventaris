...
<div class="container-fluid">	
	<div class="row justify-content-center">
		<div class="col-sm-10">			
			...
			<div class="row">
				<div class="col-sm-9">
					<a class="btn btn-sm btn-success" href="trans_peminjaman/create">Tambah Transaksi Peminjaman</a>
				</div>
				<div class="col-sm-3">
				...
				<table class="table table-bordered table-striped">
					...
					<tbody>
						...
						@endif
							...
							@if($data->peminjaman_id == "Pending" || $data->peminjaman_id == "pending")
								<td class="text-center"><form action="trans_peminjaman/{{ $data->id }}/izinkan" method="POST">
									@csrf
									@method('patch')
									<input class="btn btn-sm btn-success" type="submit" name="" value="Izinkan">
								</form></td>								
								@else
								<td class="text-center"><a class="btn btn-sm btn-warning" href="trans_peminjaman/{{ $data->id }}/kembalikan">Kembalikan</a></td>
								@endif
							
							<td class="text-center"><a class="btn btn-sm btn-info" href="trans_peminjaman/{{ $data->id }}/detail">Detail</a></td>
						</tr>
						@endforeach
					</tbody>
				</table>

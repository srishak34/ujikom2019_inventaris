...
<div class="container-fluid">
	<div class="row justify-content-center">
		<div class="col-sm-2">			
			<a class="btn btn-sm btn-secondary float-right" href="{{ url('/admin/trans_peminjaman') }}">Kembali</a>				
		</div>
		<div class="col-sm-10">			
	...
	<form action="create" method="post">
		...
		<div class="row justify-content-center">		
			<div class="col-sm-3">
				...
				<small class="d-inline text-danger">Mohon Untuk Mengisi inventarisir Terlebih Dahulu</small>
				@else					
			...
			<div class="col-sm-3">
				...
				<small class="d-inline text-danger">Mohon Untuk Mengisi Data Pegawai Terlebih Dahulu</small>
				@else					

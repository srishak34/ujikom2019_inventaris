...
<div class="container-fluid">
	<div class="row justify-content-center">
		<div class="col-sm-2">			
			<a class="btn btn-sm btn-secondary float-right" href="{{ url('/peminjam') }}">Kembali</a>				
		</div>
		<div class="col-sm-10">			
	...
	<form action="create" method="post">
		...
		<div class="row justify-content-center">		
			...
			<div class="col-sm-3">
				...
				<input class="form-control" type="text" name="c_status" value="pending" readonly>
			</div>
			<div class="col-sm-3">
			...
			<div class="col-sm-3">
				<label class="form-control-label">Nama Petugas / Pegawai :</label>
				@if(count($p) < 1)
				<select class="custom-select" disabled="disabled">
					<option>Disabled</option>
				</select>
				...
				@else
				<input name="c_pegawai" value="{{ $p->id }}" hidden>
				<input class="form-control" type="text" value="{{ $p->nama_pegawai }}" readonly>
				@endif
